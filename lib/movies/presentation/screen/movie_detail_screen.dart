      ...
      builder: (context, state) {
        switch (state.movieDetailState) {
          ...
          case RequestState.error:
            return Center(child: Text(state.movieMessage));
        }
      },
    );
  }
      ...
      builder: (context, state) {
        return SliverGrid(
          delegate: SliverChildBuilderDelegate(
            (context, index) {
              final recommendation = state.recommendationsMovie[index];
              return FadeInUp(
                from: 20,
                duration: const Duration(milliseconds: 500),
                child: ClipRRect(
            ...
            childCount: state.recommendationsMovie.length,
          ),
